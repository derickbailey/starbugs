(function (ns) {
    ...
    function buildAuthHeader(setup, options) {
    ...
    Request.prototype = {
        ...
        _init: function (options) {
            _.extend(this.headers, buildAuthHeader(this.setup, options), this._buildHeaders(options.filter), options.headers);
        },
        // Processes the given query to return appropriate headers to be used by the request
        _buildHeaders: function (query) {          
            if (query) {
                if (query instanceof Everlive.Query) {
                    return this._buildQueryHeaders(query);
                }
                else {
                    return this._buildFilterHeader(query);
                }
            }
            else {
                return null;
    ...
    Request.buildAuthHeader = buildAuthHeader;
    ...
    if (typeof Everlive.sendRequest === "undefined") {
        Everlive.sendRequest = function (request) {
            var url = buildUrl(request.setup) + request.endpoint;
